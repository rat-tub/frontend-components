...
<style>
  * {
  ...
  .background {
    background-image: url($lib/images/better.jpg);
...
<<<<<<< Updated upstream
  ...
  .toggle-menu {
    ...
    top: 100%;
    width: 30px;
    display: block; /* Show checkbox for toggling menu */
  }
  ...
  @media (max-width: 640px) {
    ...
    .toggle-menu:checked ~ .nav-links ul {
      display: flex;
      flex-direction: column;
      width: 100%;
      padding: 2rem;
    ...
    .toggle-menu:checked ~ .nav-links ul li {
      padding: 0.25rem;
    }
